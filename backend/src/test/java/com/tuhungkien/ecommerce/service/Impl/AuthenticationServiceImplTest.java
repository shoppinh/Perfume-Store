...
import com.tuhungkien.ecommerce.domain.AuthProvider;
import com.tuhungkien.ecommerce.domain.Role;
import com.tuhungkien.ecommerce.domain.User;
import com.tuhungkien.ecommerce.repository.UserRepository;
import com.tuhungkien.ecommerce.security.JwtProvider;
import com.tuhungkien.ecommerce.security.oauth2.*;
import com.tuhungkien.ecommerce.security.oauth2.*;
import com.tuhungkien.ecommerce.service.email.MailSender;
import com.tuhungkien.ecommerce.util.TestConstants;
...
public class AuthenticationServiceImplTest {
    ...
    public void findByPasswordResetCode() {
        ...
        Assertions.assertEquals(TestConstants.USER_PASSWORD_RESET_CODE, user.getPasswordResetCode());
    ...
    public void registerGoogleOauthUser() {
        ...
        Assertions.assertEquals(TestConstants.USER_EMAIL, user.getEmail());
        Assertions.assertEquals(TestConstants.FIRST_NAME, user.getFirstName());
        Assertions.assertEquals(TestConstants.LAST_NAME, user.getLastName());
